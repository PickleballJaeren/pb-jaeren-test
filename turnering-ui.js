      ...
      <div style="margin-bottom:14px">
        ...
        <div style="display:flex;flex-direction:column;gap:4px">
          ${p.lagIds.map((id, i) => {
            ...
            return `
            <div style="display:flex;align-items:center;gap:10px;padding:8px 12px;background:var(--navy3);border:1px solid var(--border);border-radius:8px;">
...
window.redigerLagNavn = function(lagId) {
  ...
  // Bytt ut innholdet med to inline inputfelt
  const midtKol = el.querySelector('div[style*="flex-direction:column"]') ?? el.querySelector('.t-lag-navn')?.parentElement;
  if (!midtKol) return;
