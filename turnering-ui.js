...
/**
 * Navigerer til en turnering og oppdaterer URL med klubb+turnering.
 * Kalles både fra oversiktslisten (onclick) og fra app.js ved lenke-oppstart.
 * @param {string} id — turneringId
 * @param {boolean} [settUrl=true] — false når URL allerede er satt (ved oppstart)
 */
...
/** Kalles fra onclick i oversiktslisten. */
window.apneTurnering = (id) => _apneTurneringKjerne(id, true);

/**
 * Kalles fra app.js ved oppstart med ?turnering= i URL.
 * URL er allerede satt — hopp over history.replaceState.
 */
