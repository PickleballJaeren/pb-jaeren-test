...
export async function visUtfordrerSkjerm() {
  const klubbId  = _getAktivKlubbId();
  console.log('[visUtfordrerSkjerm] klubbId:', klubbId, 'app.spillere:', window._app?.spillere?.length);
  console.trace('[visUtfordrerSkjerm] kalt fra');
...
async function _lastAktiveUtfordringer(klubbId, spillere) {
  ...
  try {
    ...
    console.log('[utfordringer] venter:', ventSnap.size, 'akseptert:', aksSnap.size, 'klubbId:', klubbId);
...
async function _lastSisteResultater(klubbId, spillere) {
  ...
  try {
    ...
    console.log('[resultater] ferdig:', ferdigSnap.size, 'avvist:', avvistSnap.size, 'klubbId:', klubbId);
