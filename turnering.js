...
export async function opprettTurnering(konfig) {
  ...
  const {
    ...
    kampformatSluttspill = { ...STANDARD_KAMPFORMAT, points_to_win: 15, max_points: 18 },
  } = konfig;
...
export async function registrerSluttspillResultat(turneringId, nivaa, kampId, lag1Poeng, lag2Poeng) {
  ...
  const format = t.konfig?.kampformatSluttspill ?? STANDARD_KAMPFORMAT;
