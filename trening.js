...
export async function startTrening() {
  ...
  try {
    ...
    try { history.replaceState(null, '', '?klubb=' + encodeURIComponent(_getAktivKlubbId()) + '&okt=' + treningRef.id); } catch (_) {}
    _oppdaterRundeUI();
    _naviger('baner');
    _startLyttere();
  } catch (e) {
...
export async function gjenopprettTrening(treningId) {
  ...
  try { history.replaceState(null, '', '?klubb=' + encodeURIComponent(_getAktivKlubbId()) + '&okt=' + treningId); } catch (_) {}
  _oppdaterRundeUI();
