...
export async function avsluttTreningUI() {
  ...
  // Hurtigsjekken er fjernet — kampStatusCache viser kun gjeldende rundes status
  // og kan inneholde ferdig:false for neste runde selv om tidligere runder har poeng.
  // Alltid gå til Firestore for å sjekke alle runder.
