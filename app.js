...
function byttKlubb(klubbId) {
  ...
  nullstillAdmin(); // tøm forrige klubbs admin-status
  registrerKlubbIdGetter(() => aktivKlubbId); // sørg for at nøkkelen er oppdatert
  const erAdminFraForrige = gjenopprettAdminStatus(); // gjenopprett om allerede verifisert
