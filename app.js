...
import {
  lastArkiv, apneTreningsdetalj, apneTreningsdetaljFraDom,
  visSlettOktModal, utforSlettOkt,
  visSlettAlleOkterModal, utforSlettAlleOkter,
  registrerGetAktivKlubbId as _registrerArkivGetKlubbId,
  registrerKrevAdmin as _registrerArkivKrevAdmin,
} from './arkiv.js';

// Eksponer arkiv-funksjoner for inline onclick i HTML
...
// ════════════════════════════════════════════════════════
// ØKTARKIV
// Flyttet til arkiv.js — se import øverst og init() for wiring.
// ════════════════════════════════════════════════════════
...
async function init() {
  ...
  // Koble arkiv.js til app-spesifikk logikk
  _registrerArkivGetKlubbId(() => aktivKlubbId);
  _registrerArkivKrevAdmin(krevAdminMedDemo);
