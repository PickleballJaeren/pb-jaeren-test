...
function getAdminPin() {
  // Bruk aktivKlubbId direkte, eller les fra sessionStorage som fallback
  // dersom variabelen ble nullstilt etter at appen lå i bakgrunnen.
  if (!aktivKlubbId) {
    const lagret = sessionStorage.getItem('aktivKlubbId');
    if (lagret && KLUBBER[lagret]) aktivKlubbId = lagret;
  }
