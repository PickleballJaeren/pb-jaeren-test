...
export function startRedigerRating(spillerId, gjeldende, knapp) {
  _krevAdmin('Rediger rating', 'Kun administrator kan endre ratingpoeng.', () => {
    ...
    // Gjør lb-rad om til column slik at redigeringsraden legger seg under
    const gammelFlex = lbRad.style.flexDirection;
    lbRad.style.flexWrap = 'wrap';
