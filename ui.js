...
// NAVIGASJON
// ════════════════════════════════════════════════════════
const SVEIP_FANER = ['hjem', 'baner', 'slutt', 'spillere', 'arkiv', 'turnering'];
let _aktivFane = 'hjem';
...
export function naviger(skjerm, retning = null) {
  ...
  const navMap = {
    ...
    turnering: 'nav-turnering',
    'turnering-oppsett':  'nav-turnering',
    'turnering-pulje':    'nav-turnering',
    'turnering-bracket':  'nav-turnering',
    'turnering-resultat': 'nav-turnering',
  };
  ...
  const ingenNav = ['hjem', 'poeng', 'resultat', 'profil', 'global-profil', 'treningsdetalj',
                    'turnering-oppsett', 'turnering-pulje', 'turnering-bracket', 'turnering-resultat',
                    'turnering-arkiv-detalj'];
